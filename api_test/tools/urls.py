...
urlpatterns = patterns (
			...
			url(r'^createRegionChannel$',createRegionChannel),
			url(r'^transferSecretChannel$',transferSecretChannel),
			#------------------------------------------------
			...
			# ulucu
			url(r'^detail_get$',detail_get),
			url(r'^developerGet$',developerGet),
			url(r'^openGet$',openGet),
			url(r'^SoncePerDay$',SoncePerDay),
			url(r'^DeviceOffline$',DeviceOffline),
			url(r'^snapshot$',snapshot),
			url(r'^generalAll$',generalAll),
			url(r'^shakeUp$',shakeUp),
			url(r'^imageGet$',imageGet),




			#---------weixin developer ---begin
			url(r'^getToken$',getToken),
			
			#---------weixin developer ---end
	)
